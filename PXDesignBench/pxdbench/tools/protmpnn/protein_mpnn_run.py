# This file is adapted from ProteinMPNN (https://github.com/dauparas/ProteinMPNN)
# Original implementation by Dauparas et al.
# License: MIT License (https://github.com/dauparas/ProteinMPNN/blob/main/LICENSE)
